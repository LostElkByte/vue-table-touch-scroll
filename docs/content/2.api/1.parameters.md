---
title: Options & Types
description: Option tables, TypeScript types, and library exports for Vue Table Touch Scroll.
icon: lucide:file-json
---

## vTableTouchScroll

A Vue 3 custom directive that adds touch scroll support to table elements. In templates, use the `v-table-touch-scroll` attribute. For global registration and local import, see the [Usage Guide](/guide/configuration).
