...
This page covers common usage patterns for the `v-table-touch-scroll` directive. For complete configuration options and type definitions, see [API](/api/parameters).
