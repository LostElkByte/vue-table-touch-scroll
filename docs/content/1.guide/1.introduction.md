...
`v-table-touch-scroll` addresses these by intercepting touch flow and running an in-directive scroll physics engine; see [How It Works](/how-it-works/how-it-works) for the full breakdown.
